...
# ╔═╡ 7ba198e0-3441-11ed-2c3c-635e4fcd75ac
using Flux

# ╔═╡ 61d37130-0b4d-4ca3-94e4-8ba7d23bf358
begin
	N, M = 5, 5
	Nh = 10

	model = Chain(Dense(N => Nh), Dense(Nh => 2, tanh))
end

# ╔═╡ fb971e3d-909f-4366-a8c8-7538f6519bd0
model(ones(5))

# ╔═╡ 15c83ad2-5bbe-44cd-b55f-87899e8fce2b


# ╔═╡ 7852a96d-9782-4430-9fc3-e08178d3acc4
loss
...
julia_version = "1.8.1"
manifest_format = "2.0"
project_hash = "f082faadb5ab2387ceac01bbf9e6aef7ac642bf9"
