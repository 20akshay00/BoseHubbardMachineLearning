...
using AutoGrad, Plots, StatsBase
...
begin
	struct Dense
		...
		b # Bias
		f # Activation
		Dense(i::Int, o::Int, f = identity) = new(Param(rand(o, i)), Param(rand(o)), f)
	end
...
# ╔═╡ f09d86fb-739c-4255-862a-c9e54b392874
md"""
## Issues
- fixed N; solved
- hopping operators dont annihilate yet; solved
- type instability in parameter flattening; ANY!!!
"""
...
julia_version = "1.8.0"
manifest_format = "2.0"
project_hash = "1f86bb114329620102c4efef1115a441ad2e1867"
